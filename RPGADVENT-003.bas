...
'COMMAND USE COMMAND USE COMMAND USE COMMAND USE COMMAND USE COMMAND USE COMMAND USE COMMAND USE COMMAND USE COMMAND USE COMMAND USE
        ...
        874 ?"use with object?";ob(ob1,7): if ob(ob(ob1,7),1)=lo then ? "present.":triggerit=ob(ob(ob,7),8)
        ...
        885 if ob(ob1,6)<0 then print er$(5):goto 995 else ob2= ob(ob1,6): swap ob(ob1,1), ob(ob2,1): PRINT act$(ob(ob2,7));". ";EX$(ob(ob2,5))
'------------------------------------------------------------------------------------------------------------------------------------
